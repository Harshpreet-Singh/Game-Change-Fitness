...
$(document).ready(function() {
  ...
  $('#selectPageType').on('change', function () {
    var optionval = $(this).val(); // get selected value
    if(optionval == 'recipes') {
      $(".selectnone").hide();
      $("#selectRecipe").show();
    }
    if(optionval == 'forumArticle') {
      $(".selectnone").hide();
      $("#selectForum").show();
    }
    if(optionval == 'nutritionGuidance') {
      $(".selectnone").hide();
      $("#selectNutritionGuide").show();
    }
    if(optionval == 'training') {
      $(".selectnone").hide();
      $("#selectTranining").show();
    }
    if(optionval == 'recommendedProducts') {
      $(".selectnone").hide();
      $("#selectRecommendedProd").show();
    }
  });
